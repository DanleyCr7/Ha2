      ...
      <View style={styles.container}>
        <ScrollView>
          ...
          <View style={styles.HanTipos}>
            <Text style={styles.TitleTipo}>Vigilância de contatos</Text>
            ...
            <View style={{ flexDirection: 'row' }}>
              <TouchableOpacity style={styles.BotaoTipo} onPress={() => { }}>
                <Text style={styles.textTipo}>Notificação</Text>
              </TouchableOpacity>
              <TouchableOpacity style={styles.BotaoTipo} onPress={() => { }}>
                <Text style={styles.textTipo}>Acompanhamento</Text>
              </TouchableOpacity>
            </View>
          ...
          <View style={styles.viewCam}>
            ...
            <TouchableOpacity style={styles.butaoAnalise} onPress={() => this.props.navigation.navigate('Formulario'
              ...
              <Text style={styles.butaoTextoAnalise}>Exame</Text>
            </TouchableOpacity>
          </View>
        </ScrollView>
      </View >
